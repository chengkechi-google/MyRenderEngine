...
namespace eastl
{
    ...
    struct hash<RHIShaderDesc>
    {
        ...
        {
            eastl::string s = desc.m_file + desc.m_entryPoint + desc.m_profile;
...
public:
    ...
    IRHIShader* GetShader(const eastl::string& file, const eastl::string& entryPoint, const eastl::string& profile, const eastl::vector<eastl::string>& defines, RHIShaderCompilerFlags flags);
    eastl::string GetCachedFileContent(const eastl::string& file);
    void ReloadShaders();
private:
    IRHIShader* CreateShader(const eastl::string& file, const eastl::string& entryPoint, const eastl::string& profile, const eastl::vector<eastl::string>& defines, RHIShaderCompilerFlags flags);
